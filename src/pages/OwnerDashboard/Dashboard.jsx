...
const menuItems = [
    ...
    { icon: <FaList />, title: "My Listings" },
    { icon: <FaPlusCircle />, title: "Post Room" },
    { icon: <FaEnvelope />, title: "Inquiries" },
    { icon: <FaCalendarCheck />, title: "Bookings" },
    { icon: <FaComments />, title: "Messages" },
    { icon: <FaWallet />, title: "Earnings" },
            ...
            <aside className="w-72 bg-white shadow-xl flex flex-col">
                ...
                <div className="flex-1 p-5 space-y-2">
                    ...
                    {menuItems.map((item, index) => (
                        <button
                            key={index}
                            className={`w-full flex items-center gap-4 px-5 py-4 rounded-xl duration-300
              ${item.active
                ...
                <div className="p-5 border-t">
                    ...
                    <button className="w-full flex items-center gap-4 px-5 py-4 rounded-xl hover:bg-red-50 text-red-600 duration-300">
                        <FaSignOutAlt />
                        Logout
                    </button>
            ...
            <main className="flex-1">
                ...
                <div className="bg-white h-20 shadow-sm px-8 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <button className="relative bg-slate-100 p-3 rounded-xl hover:bg-blue-100">
