...
const BasicDetails = () => {
    ...
    return (
        <div className="flex min-h-screen bg-[#f5f8ff]">
            ...
            <aside className="w-72 bg-[#071a3d] text-white flex flex-col">
                ...
                <nav className="flex-1 mt-8">
                    ...
                    <ul className="space-y-3 px-5">
                        ...
                        <li className="flex items-center gap-4 px-5 py-4 rounded-xl hover:bg-blue-700 duration-300 cursor-pointer">
                            <FaHome />
                            Dashboard
                        </li>
                        ...
                        <li className="flex items-center gap-4 px-5 py-4 rounded-xl bg-blue-600 cursor-pointer">
                            <FaPlusCircle />
                            Post Room
                        </li>
                        ...
                        <li className="flex items-center gap-4 px-5 py-4 rounded-xl hover:bg-red-600 duration-300 cursor-pointer">
                            <FaSignOutAlt />
                            Logout
                        </li>
                ...
                <div className="m-5 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-500 p-6">

                    <FaCrown className="text-3xl mb-4" />
                    ...
                    <p className="text-sm mt-3 text-blue-100">
                        Get more visibility, priority listing and faster bookings.
                    </p>

                    <button className="w-full mt-5 py-3 rounded-xl bg-white text-blue-700 font-bold hover:scale-105 duration-300">
                        Upgrade Now
                    </button>
